...
# --master_port 29501 \
# tools/deprecated/train.py \
# mytrain_coco_bs96_lr14_280eps_gpu2_distri/nanodet-m.yml \
# &

# tensorboard --logdir=/home/gbc/workspace/nanodet/mytrain_coco_bs96_lr14_280eps_gpu2_distri --port=10002 --bind_all &